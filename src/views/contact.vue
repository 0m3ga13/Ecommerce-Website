<template>
    <section class="text-gray-600 body-font relative dark:bg-black dark:text-white sm:overflow-hidden">
  <div class="absolute inset-0 bg-gray-300">
    <iframe width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" title="map" scrolling="no" src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=%C4%B0zmir+(My%20Business%20Name)&ie=UTF8&t=&z=14&iwloc=B&output=embed" style="filter: grayscale(0) contrast(1) opacity(0.6);"></iframe>
  </div>
  <div class="container px-5 py-24 mx-auto flex  ">
    <div class="lg:w-1/3 md:w-1/2 bg-white z-0 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-m dark:bg-black dark:text-white ">
      ...
      <div class="relative mb-4">
        ...
        <input type="email" id="email" name="email" class="w-full bg-white rounded border dark:text-white border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
      </div>
      <div class="relative mb-4">

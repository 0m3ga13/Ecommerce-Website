<template>
    <div class="relative h-screen isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      <img src="https://images.unsplash.com/photo-1536300099515-6c61b290b654?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-y=.8&w=2830&h=1500&q=80&blend=111827&sat=-100&exp=15&blend-mode=multiply" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center" />
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Why choosing us?</h2>
        ...
        <div class=" mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <dl class="hidden mt-16 sm:grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
  ...
  const stats = [
    { name: 'Clients all over Algeria', value: '10 000+' },
    { name: 'Delivery Average Time', value: '24h' },
    { name: 'Opens Daily', value: '7/7' },
